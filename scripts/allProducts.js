...
let url = "https://lapis-quixotic-dracorex.glitch.me/products?";
...
sort.onchange = () => {
  ...
  switch (value) {
    case "lh":
      getData(url + "_sort=mrp&_order=asc&", [appendProducts, "#products"]);
      break;
    case "hl":
      getData(url + "_sort=mrp&_order=desc&", [appendProducts, "#products"]);
      break;
    case "discount":
      getData(url + "_sort=discount&_order=desc&", [
        appendProducts,
        "#products",
      ]);
      break;
    case "rating":
      getData(url + "_sort=rating&_order=desc&", [appendProducts, "#products"]);
      break;
    default:
      getData(url, [appendProducts, "#products"]);
  }
