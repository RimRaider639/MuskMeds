...
const getimageurl = async () => {
  ...
  let response = await fetch(
    "https://api.imgbb.com/1/upload?key=2d55f2865b5d703bd09975b5a32dfb5a",
    {
      method: "POST",
      body: form,
    }
...
const add_product = async () => {
  ...
  let response = await fetch(
    "https://lapis-quixotic-dracorex.glitch.me/products",
    {
      method: "POST",
...
const getdata = async () => {
  let res = await fetch(`https://lapis-quixotic-dracorex.glitch.me/products`);
  let originaldata = await res.json();
  let response = await fetch(
    `https://lapis-quixotic-dracorex.glitch.me/products?email=${email}`
  );
  let data = await response.json();
  console.log(data);
...
const deleteproduct = async (x) => {
  let response = await fetch(
    `https://lapis-quixotic-dracorex.glitch.me/products/${x}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
let updatemrp = async (y) => {
  ...
  let response = await fetch(
    `https://lapis-quixotic-dracorex.glitch.me/products/${y}`,
    {
      method: "PATCH",
...
const updatestock = async (z) => {
  ...
  let response = await fetch(
    `https://lapis-quixotic-dracorex.glitch.me/products/${z}`,
    {
      method: "PATCH",
      body: JSON.stringify(send_this_data),
      headers: {
...
const checkorders = async () => {
  let res = await fetch(`https://lapis-quixotic-dracorex.glitch.me/orders`);
  let originaldata = await res.json();
  let response = await fetch(
    `https://lapis-quixotic-dracorex.glitch.me/orders?email=${email}`
  );
  let data = await response.json();
  console.log(data);
  if (data.length != originaldata.length) {
